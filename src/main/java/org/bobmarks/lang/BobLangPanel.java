...
public class BobLangPanel extends JPanel implements ActionListener, CaretListener, FocusListener, KeyListener, MouseListener {
    ...
    private JSplitPane getControlPanel() {
        ...
        JSplitPane left = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT, getTitledScrolledPanel("Course", coursePanel,
            true), getTitledScrolledPanel("Lesson", lessonPanel, true));
        JSplitPane right = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT, getTitledScrolledPanel("Topic", topicPanel,
            true), getTitledScrolledPanel("Actions", getActionsPanel(), false));
    ...
    private void edit() {
        if (JOptionPane.showConfirmDialog(getParent(), "Are you sure you want to switch to edit mode", "Switch to edit mode",
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    if (question.length != answer.length) {
                        JOptionPane.showMessageDialog(getParent(),
                            "Question [ " + question.length + " ] and Answer [ " + answer.length + " ] rows different");
                        return;
                    }
            ...
            JSplitPane pane = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT, getEditTextPanel("Questions",
                questionTA), getEditTextPanel("Answer", answerTA));
